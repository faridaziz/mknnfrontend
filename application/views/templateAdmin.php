                        ...
                        <li class="nav-item dropdown <?= $this->uri->segment(2) == 'data_mobil' || $this->uri->segment(2) == 'data_review' || $this->uri->segment(2) == 'tipe' ? 'active' : ''; ?>">
                            ...
                            <ul class="dropdown-menu">
                                <li class="<?= $this->uri->segment(2) == 'data_mobil' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/mobil'); ?>"><i class="fas fa-file"></i> <span>Data Training</span></a>
                                </li>
                                <li class="<?= $this->uri->segment(2) == 'tipe' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/tipe'); ?>"><i class="fas fa-file"></i> <span>Data Testing</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown <?= $this->uri->segment(2) == 'transaksi' || $this->uri->segment(2) == 'laporan' ? 'active' : ''; ?>">
                            ...
                            <ul class="dropdown-menu">
                                <li class="<?= $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/transaksi'); ?>"><i class="fas fa-clipboard-list"></i> <span>tahapan pengujian</span></a>
                                </li>
                                <li class="<?= $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/transaksi'); ?>"><i class="fas fa-clipboard-list"></i> <span>pengujian K3</span></a>
                                </li>
                                <li class="<?= $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/transaksi'); ?>"><i class="fas fa-clipboard-list"></i> <span>pengujian k5</span></a>
                                </li>
                                <li class="<?= $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/transaksi'); ?>"><i class="fas fa-clipboard-list"></i> <span>pengujian k7</span></a>
                                </li>
                                <li class="<?= $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/transaksi'); ?>"><i class="fas fa-clipboard-list"></i> <span>pengujian k9</span></a>
                                </li>
                                <li class="<?= $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>">
                                    <a class=" nav-link" href="<?= site_url('admin/transaksi'); ?>"><i class="fas fa-clipboard-list"></i> <span>pengujian k11</span></a>
                                </li>
                            </ul>
                        </li>

...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">M <span>K-NN</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item <?= $this->uri->segment(1) == 'mobil' ? 'active' : ''; ?>"><a href="<?= site_url('mobil'); ?>" class="nav-link">Hasil 100</a></li>
					<!-- <li class="nav-item"><a href="#" class="nav-link">Blog</a></li> -->
					<li class="nav-item <?= $this->uri->segment(1) == 'contact' ? 'active' : ''; ?>"><a href="<?= site_url('contact'); ?>" class="nav-link">Hasil 300</a></li>
					<li class="nav-item <?= $this->uri->segment(1) == 'contact' ? 'active' : ''; ?>"><a href="<?= site_url('contact'); ?>" class="nav-link">Hasil 500</a></li>
					<li class="nav-item <?= $this->uri->segment(1) == 'contact' ? 'active' : ''; ?>"><a href="<?= site_url('contact'); ?>" class="nav-link">Hasil 700</a></li>
					<li class="nav-item <?= $this->uri->segment(1) == 'contact' ? 'active' : ''; ?>"><a href="<?= site_url('contact'); ?>" class="nav-link">Hasil 1000</a></li>
					<div class="ml-5"></div>
			...
			<div class="row mb-2">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2"><a href="#" class="logo">M <span>K-NN</span></a></h2>
						<p>Hasil analisis sentimen opini masyarakat terhadap windows 11 pada twitter menggunakan metode modified k-nearest neighbour</p>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-5">
						...
						<ul class="list-unstyled">
							<li><a href="#" class="py-2 d-block">Data Training</a></li>
							<li><a href="#" class="py-2 d-block">Data Testing</a></li>
							<li><a href="#" class="py-2 d-block">Hasil</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><a href="#"><span class="icon icon-map-marker"></span><span class="text">Politeknik Negeri Malang.</span></a></li>
								<li><a href="#"><span class="icon icon-phone"></span><span class="text">+62 82244922833</span></a></li>
								<li><a href="#"><span class="icon icon-envelope"></span><span class="text">irvanhidayat0623@gmail.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p>
						...
						<i class="icon-heart color-danger" aria-hidden="true"></i> By <a href="" target="_blank">Irvan
							Alfi</a>
					</p>
				</div>
			</div>
